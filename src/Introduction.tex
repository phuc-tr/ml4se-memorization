...
Recent research on memorization in LLMs was performed on the assumption that a dataset had been seen in the training process to unveil the effect of memorization by comparing the similarities between LLM output and the training data \cite{mem_stackoverflow} \cite{demystifying} \cite{memorizegeneralizeevaluatingllm}. Input data mutation was also investigated to understand memorization \cite{demystifying} \cite{memorizegeneralizeevaluatingllm}. However, the study of LLM memorization in code translation tasks is yet to be discussed.
